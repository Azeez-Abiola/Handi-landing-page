...
const sections = [
  {
    ...
    content: (
      <>
        ...
        <p className="font-body text-sm text-gray-600 leading-relaxed mb-4">
          The personal information we collect may include: <span className="text-gray-800">names, phone numbers, email addresses, usernames, passwords, photos, and addresses.</span>
        </p>
  ...
  },
  {
    ...
    content: (
      <div className="font-body text-sm text-gray-600 leading-relaxed space-y-1">
        <p>If you have questions or comments, you may email us at <a href="mailto:support@tryhandi.com" className="text-[#0C9348] font-medium hover:underline">support@tryhandi.com</a> or by post at:</p>
