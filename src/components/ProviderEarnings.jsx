...
const VerifiedIcon = () => (
  <span className="relative inline-block" style={{width: '12.76px', height: '12.64px'}}>
    <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" style={{position: 'absolute', top: '1.06px', left: '1px', width: '10.76px', height: '10.64px'}}>
  ...
  return (
    <section className="bg-hero-bg py-12 md:py-20 px-4 select-none overflow-x-hidden">
      <div className="max-w-[1483px] min-h-[759px] bg-[#044422] rounded-[24px] mx-auto p-8 lg:p-16 flex flex-col lg:flex-row items-start lg:items-stretch justify-between relative overflow-hidden shadow-2xl">
        ...
        {/* Left Column: text + button (always), list items desktop-only */}
        <div className="flex flex-col max-w-[540px] justify-center z-10 w-full mb-8 lg:mb-0">
          ...
          {/* List items — desktop only (mobile list appears below the image) */}
          <div className="hidden lg:block">
            <ListItems />
          </div>
        </div>

        {/* Right Column: image + floating cards — visible on both mobile and desktop */}
        <ScrollReveal direction="right" className="relative w-full lg:w-[700px] shrink-0 z-10 h-[440px] lg:h-auto lg:min-h-[680px]">

          {/* Main image */}
          <div
            style={{ borderRadius: '16px', overflow: 'hidden', backgroundColor: '#E0FAF2' }}
            className="shadow-2xl select-none pointer-events-none absolute inset-x-0 top-[40px] bottom-0 lg:absolute lg:top-[33px] lg:left-[161px] lg:w-[485px] lg:h-[566px] lg:inset-x-auto"
          >
            <img src="/images/expand-yourearnings-img.png" alt="Expand your earnings" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center top', display: 'block' }} draggable="false" />
          </div>

          {/* 1. Earnings Card — mobile: left-center, desktop: existing */}
          <div
            className="absolute bg-white text-gray-900 shadow-2xl z-20 flex flex-col justify-between select-none top-[160px] left-0 lg:top-[170px] lg:left-[-12px]"
            style={{ width: 'min(260px, 68%)', height: 'auto', borderRadius: '11.42px', padding: '14px 18px', gap: '16px' }}
          >
            <span style={{ fontFamily: "'Google Sans', 'Plus Jakarta Sans', sans-serif", fontWeight: 400, fontSize: '9.87px', lineHeight: '1.15', letterSpacing: '-0.01em' }} className="text-gray-400 uppercase block">Earnings this week</span>
            <h3 className="font-heading text-xl lg:text-[28px] font-bold text-gray-900 leading-none">₦180,000.00</h3>
            <div className="flex gap-2">
              <button className="bg-gray-100 text-gray-900 rounded-xl px-3 py-1.5 text-xs font-body font-semibold flex items-center gap-1.5">Withdraw <ArrowRightIcon /></button>
              <button className="border border-gray-200 rounded-xl px-2 py-1.5 text-xs font-body font-semibold flex items-center gap-1.5">Payment details <PaymentDetailsIcon /></button>
            </div>
          </div>

          {/* 2. Progress Badge — mobile: top-right, desktop: existing */}
          <div
            className="absolute bg-white text-gray-900 shadow-2xl z-20 flex flex-col justify-between top-0 right-0 lg:top-[16px] lg:left-[442px] lg:right-auto"
            style={{ width: '200px', height: '65px', gap: '10px', borderRadius: '10.24px', padding: '12px' }}
          >
            <div className="flex justify-between items-center">
              <span className="font-heading text-xs font-extrabold text-gray-900 leading-none">10 <span className="text-gray-400 font-normal">/50 jobs done</span></span>
              <span className="bg-[#FFF5E6] text-[#C88149] text-[8px] font-extrabold px-1.5 py-0.5 rounded flex items-center gap-0.5"><VerifiedIcon /> VERIFIED</span>
            </div>
            <div className="w-full bg-gray-100 h-1.5 rounded-full overflow-hidden"><div className="bg-[#00F676] h-full w-[25%]" /></div>
          </div>

          {/* 3. Install Ceiling Fan — mobile: bottom-right, desktop: existing */}
          <div
            className="absolute bg-white text-gray-900 shadow-2xl z-20 flex flex-col justify-between bottom-0 right-0 lg:top-[462px] lg:left-[411px] lg:bottom-auto lg:right-auto"
            style={{ width: '240px', height: 'auto', minHeight: '140px', gap: '10px', paddingTop: '12px', paddingRight: '8px', paddingBottom: '12px', paddingLeft: '8px', borderRadius: '12px', borderBottomWidth: '0.81px', borderColor: '#e5e7eb' }}
          >
            ...
            <p className="font-body text-[9px] text-gray-500 leading-normal mb-1 px-1">I need a ceiling fan installed in my living room to improve airflow.</p>
            <div className="flex flex-col gap-1 border-b border-gray-100 pb-2 mb-1 px-1">
              <div className="flex items-center gap-1 text-[8px] text-gray-400 font-medium"><svg width="11" height="11" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0"><path d="M7.91967 5.36901C7.91967 6.18442 7.25864 6.84545 6.44323 6.84545C5.62781 6.84545 4.96678 6.18442 4.96678 5.36901C4.96678 4.55359 5.62781 3.89256 6.44323 3.89256C7.25864 3.89256 7.91967 4.55359 7.91967 5.36901Z" stroke="#393939" strokeWidth="1.208"/><path d="M10.3357 5.36901C10.3357 8.63087 6.44323 11.4857 6.44323 11.4857C6.44323 11.4857 2.55078 8.63087 2.55078 5.36901C2.55078 3.21927 4.29349 1.47656 6.44323 1.47656C8.59296 1.47656 10.3357 3.21927 10.3357 5.36901Z" stroke="#393939" strokeWidth="1.208"/></svg><span className="truncate">Greenfield Estates, Lekki, Lagos</span></div>
              <div className="flex items-center gap-1 text-[8px] text-gray-400 font-medium"><svg width="11" height="11" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0"><g clipPath="url(#cc)"><path d="M4.16123 2.55034H2.55056C2.25405 2.55034 2.01367 2.79071 2.01367 3.08723V4.96634M4.16123 2.55034H8.72478M4.16123 2.55034V1.47656M8.72478 2.55034H10.3354C10.632 2.55034 10.8723 2.79071 10.8723 3.08723V4.96634M8.72478 2.55034V1.47656M6.04034 10.8721H2.55056C2.25405 10.8721 2.01367 10.6317 2.01367 10.3352V4.96634M2.01367 4.96634H10.8723M10.8723 4.96634V6.57701M11.4092 8.45612L9.08271 11.409L7.91945 10.2279" stroke="#393939" strokeWidth="1.208" strokeLinecap="round" strokeLinejoin="round"/></g><defs><clipPath id="cc"><rect width="12.8853" height="12.8853" fill="white"/></clipPath></defs></svg><span>On 15th July, 2026</span></div>
            </div>
            <div className="flex items-center gap-2 px-1">
              <div className="w-6 h-6 rounded-full bg-[#EBF5FF] text-[#0066CC] font-heading text-[9px] font-bold flex items-center justify-center shrink-0">CO</div>
              <div className="flex flex-col"><span className="font-body text-[9px] font-bold text-gray-900 leading-none mb-0.5">Chisom Okeke</span><span className="text-[7px] text-gray-400">11 km • 2 mins ago</span></div>
            </div>
          </div>

        </ScrollReveal>

        {/* Mobile-only list items — appears below the image */}
        <div className="block lg:hidden w-full z-10 mt-8">
          <ListItems />
        </div>
