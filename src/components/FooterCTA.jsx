    ...
    <section className="bg-black py-20 md:py-24 select-none relative overflow-hidden flex flex-col items-center justify-center min-h-[480px] md:min-h-[560px]">
      ...
      <ScrollReveal className="w-full max-w-[500px] z-10 px-6 flex flex-col items-center justify-center text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center w-full">
          <a
            href="#"
            className="w-full sm:w-auto bg-[#0C9348] text-white rounded-xl px-7 py-3.5 font-body font-semibold text-sm flex items-center justify-center gap-2 transition-all duration-300 hover:bg-[#096a34] hover:-translate-y-0.5"
          >
            Post a Task
          ...
          <a
            href="#"
            className="w-full sm:w-auto bg-white text-gray-900 rounded-xl px-7 py-3.5 font-body font-semibold text-sm flex items-center justify-center gap-2 transition-all duration-300 hover:bg-gray-100 hover:-translate-y-0.5"
          >
            Earn Money on Handi
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
