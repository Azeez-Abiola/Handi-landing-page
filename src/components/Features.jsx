  ...
  const props = [
    {
      ...
      desc: "Find trusted professionals near you and book in minutes. Every professional is background checked and rated by real customers. No guessing.",
      icon: (
    ...
    },
    {
      ...
      desc: "Most jobs matched within minutes. Many professionals are available the same day to serve your urgent needs.",
      icon: (
        <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-gray-900">
